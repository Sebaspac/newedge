...
/** Umlaufender Randtext des Buttons — sprachabhängig (rendert auch auf /en). */
const REVOLVING_TEXT = {
  de: "KOSTENLOSES ERSTGESPRÄCH · JETZT BUCHEN · ",
  en: "FREE INTRO CALL · BOOK NOW · ",
} as const;
        ...
        <div style={{
          ...
          <svg viewBox="0 0 200 200" style={{ width: "100%", height: "100%" }}>
            ...
            <text style={{ fontSize: "17px", fill: textColor ?? "#171717", fontFamily: "Consolas, ui-monospace, monospace", letterSpacing: "0.04em" }}>
              <textPath href="#fcb-circle" startOffset="0%">{REVOLVING_TEXT[language === "en" ? "en" : "de"]}</textPath>
            </text>
          </svg>
