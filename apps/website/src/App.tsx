...
const appRoutes = () => (
  <>
    ...
    <Route path="loesungen/entscheidungen-fallpruefung" element={<PainPointAuswahlverfahren />} />
    <Route path="leistungen/pain-points/entscheidungen-fallpruefung" element={<PainPointAuswahlverfahren />} />
    {/* Alle Pain-Point- & Industrie-Unterseiten nutzen dieselbe Struktur wie Entscheidungen & Fallprüfung.
        Alte Slugs (auswahlverfahren, compliance, kpi-dashboard, ki-kundensupport,
        entscheidungsinstanzen) laufen über die :slug-Routen und die Alias-Keys
        in painPoints.ts weiter auf denselben Inhalt. */}
    ...
    {/* Sicherheit, Datenschutz & Betrieb — die Fragen, die vor jedem Projekt zuerst kommen */}
