...
export const cortexPage = {
  seo: {
    title: "Cortex: Secure AI Platform for Mid-Sized Companies | NEWEDGE",
    description:
      "Cortex is the central AI platform for mid-sized companies: one secure access point for your team, full control over usage and data — GDPR-compliant and in-house.",
    canonical: "/en/cortex",
