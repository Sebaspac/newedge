...
export const videoShowcase = {
  heading: "NEWEDGE in action.",
  sub: "How scattered AI tools become a working AI department — explained in a short video.",
  /** Primärer CTA → /ki-audit. */
  ctaPrimary: { label: "Calculate your AI potential", to: "/ki-audit" },
  /** Sekundärer CTA → öffnet Kontakt-Dialog. */
  ctaSecondary: { label: "Free analysis" },
} as const;
