...
export const positionedForImpact = {
  ...
  /** Alt-Texte des Gründer-Foto-Duos (Split-Spread links, zwei Event-Fotos). */
  portraitDuo: {
    alt1: "Sebastian & Wenjamin, founders of NEWEDGE, at the European Business Forum",
    alt2: "Sebastian & Wenjamin, founders of NEWEDGE",
  },
  ...
  stats: [
    { value: "5–150", label: "Employees — companies like yours" },
    { value: "30%", label: "Time back in day-to-day work" },
    { value: "4x", label: "your investment pays off" },
  ] as Stat[],
