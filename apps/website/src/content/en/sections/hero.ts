...
export const hero = {
  ...
  subline:
    "AI is everywhere — but in mid-sized companies it too often stays a siloed tool or a liability. We give your company its own AI capability: from the first analysis that shows where it pays off, all the way to running operations. Not another tool — a department that takes over work.",
