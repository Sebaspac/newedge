...
export const jobs: Job[] = [
  {
    ...
    mailto: "mailto:info@newedgebrand.com?subject=Application: Internship Marketing & Project Management",
    sections: [
      {
        label: "Your tasks",
        items: [
  ...
  },
  {
    ...
    mailto: "mailto:info@newedgebrand.com?subject=Application: Sales & Business Development",
    sections: [
      {
        label: "Mission",
        items: [
  ...
  },
  {
    ...
    tags: ["📍 Remote/Munich", "💼 Full-time, 3–6 months", "🚀 Start anytime"],
    mailto: "mailto:info@newedgebrand.com?subject=Application: Internship Sales & Business Development",
    sections: [
      {
        label: "Your tasks",
        items: [
  ...
  },
  {
    ...
    mailto: "mailto:info@newedgebrand.com?subject=Application: Working Student DevOps & Full-Stack",
    sections: [
      {
        label: "Your tasks",
        items: [
