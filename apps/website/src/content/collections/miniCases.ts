  ...
  entscheidungsinstanzen: [
    {
      ...
      title: "BMP Award — Von 275 Bewerbungen im Excel zur automatisierten Jury-Pipeline",
      teaser:
    ...
    },
    {
      ...
      title: "Hochschule — Zulassungsverfahren für Master-Bewerbungen automatisiert",
      teaser:
        "Die formale Vorprüfung läuft automatisch — Zulassungsbescheide gehen spürbar früher raus.",
      scenario:
        "Beispiel-Szenario: Private Hochschule · hohes Bewerbungsaufkommen pro Semester · formale Vorprüfung durch das Zulassungsteam.",
      situation:
        "Jede Bewerbung wurde manuell geprüft — Noten, Sprachzertifikate, Motivations- und Empfehlungsschreiben. Die Formalprüfung band einen Großteil der Kapazität, bevor die fachliche Vorauswahl überhaupt begann.",
      approach: [
      ...
      result:
        "Zulassungsbescheide gehen spürbar früher raus. Die formale Prüfung läuft nahezu vollautomatisch — fehlende Unterlagen fallen sofort auf statt erst spät im Verfahren.",
      metrics: [
        { value: "Automatisch", label: "formale Vorprüfung statt manueller Sichtung" },
        { value: "Früher", label: "versendete Zulassungsbescheide" },
        { value: "Vollständig", label: "geprüfte Unterlagen vor der fachlichen Begutachtung" },
      ],
      image: { src: "hochschul-zulassung-case", alt: "Hochschule — Zulassungsverfahren für Master-Bewerbungen automatisiert" },
    },
    {
      ...
      teaser:
        "Die Formalprüfung läuft automatisch — das Bewilligungsgremium tagt monatlich statt quartalsweise.",
      scenario:
      ...
      result:
        "Die formale Prüfung ist kein Engpass mehr: Das Gremium tagt monatlich statt quartalsweise, und Abweichungen beim Kriterien-Abgleich fallen automatisch auf, statt übersehen zu werden.",
      metrics: [
        { value: "Automatisch", label: "Abgleich gegen das Förderregelwerk" },
        { value: "Monatlich", label: "Gremiumssitzungen statt quartalsweise" },
        { value: "Vollständig", label: "geprüfte Nachweise je Antrag" },
      ],
