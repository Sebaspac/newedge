...
export const hero = {
  ...
  subline:
    "KI ist überall — im Mittelstand bleibt sie zu oft Insellösung oder Risiko. Wir bauen Ihre eigene KI-Fähigkeit auf: von der Analyse, die zeigt, wo KI sich lohnt, bis zum laufenden Betrieb. Kein weiteres Tool — eine Abteilung, die Arbeit übernimmt.",
